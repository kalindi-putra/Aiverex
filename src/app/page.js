    ...
    <div className="col text-white">
      <div className="px-5 py-5 mt-5">
        ...
        <div className="px-2 py-2">
          <Link href={isLoggedIn?'/home':'/login'} className={`${styles["btn"]} btn ${styles["btn-outline-primary"]}`}>Explore More About Us</Link>
        </div>
      </div>
    </div>
</div>
...
<div className={`${styles["footer-container"]} ${styles["foot"]} p-5`}>
  ...
  <Link className={`${styles['navLogo']} navbar-brand`} href="/" ><img src="https://aivirex.in/assets/img/favicon/apple-touch-icon.png" alt="" width="30" height="24" className="d-inline-block align-text-top"/>
      							AIVIREX
	  					</Link>	
